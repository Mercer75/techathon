...
public final class DaggerMainApplication_HiltComponents_SingletonC extends MainApplication_HiltComponents.SingletonC {
  ...
  private HealthServicesManager healthServicesManager() {
    return new HealthServicesManager(ApplicationContextModule_ProvideContextFactory.provideContext(applicationContextModule), provideHealthServicesClientProvider.get());
  }

  private RegisterForBackgroundDataWorker registerForBackgroundDataWorker(Context appContext,
  ...
  private void initialize(final ApplicationContextModule applicationContextModuleParam,
    ...
    this.provideHealthServicesClientProvider = DoubleCheck.provider(new SwitchingProvider<HealthServicesClient>(singletonC, 1));
    this.registerForBackgroundDataWorker_AssistedFactoryProvider = SingleCheck.provider(new SwitchingProvider<RegisterForBackgroundDataWorker_AssistedFactory>(singletonC, 0));
    this.provideDataStoreProvider = DoubleCheck.provider(new SwitchingProvider<DataStore<Preferences>>(singletonC, 2));
  }
  ...
  @Override
  public void injectPassiveDataReceiver(PassiveDataReceiver arg0) {
    injectPassiveDataReceiver2(arg0);
  }
  ...
  @CanIgnoreReturnValue
  private PassiveDataReceiver injectPassiveDataReceiver2(PassiveDataReceiver instance) {
    PassiveDataReceiver_MembersInjector.injectRepository(instance, passiveDataRepository());
    return instance;
  }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          ...
          return (T) new MainViewModel(singletonC.passiveDataRepository(), singletonC.healthServicesManager());
      ...
      switch (id) {
        ...
        return (T) new RegisterForBackgroundDataWorker_AssistedFactory() {
          ...
          public RegisterForBackgroundDataWorker create(Context appContext,
              WorkerParameters workerParams) {
            return singletonC.registerForBackgroundDataWorker(appContext, workerParams);
          }
        };
        ...
        return (T) MainModule_ProvideDataStoreFactory.provideDataStore(singletonC.mainModule, ApplicationContextModule_ProvideContextFactory.provideContext(singletonC.applicationContextModule));
